...
$DATABASE_HOST = 'db5015657427.hosting-data.io';
$DATABASE_USER = 'dbu2673090';
$DATABASE_PASS = 'OswegoHistory1848!';
$DATABASE_NAME = 'dbs12781635';
try {
...
if (isset($_GET['page_id'])) {
   ...
   $originals = array("fuck","damn", "ass" , "shit", "instance8" );
    ...
    for ( $x = 0; $x < count($originals); $x++){
$bad = $originals[$x];
    if (strstr($comments, $bad)) { 
      exit ('Comment contains bad words') ;
   }
    }
